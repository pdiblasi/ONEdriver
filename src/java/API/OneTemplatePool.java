...
public class OneTemplatePool {
    ...
    /**
     * Creates a new instance of OneTemplatePool
     */
    public OneTemplatePool() {
       try{
     ...
     */
    @GET
    @Path("info/{int_filter_flag}/{int_range_start_id}/{int_range_end_id}")
    @Produces(MediaType.TEXT_PLAIN)
    public String info(@PathParam("int_filter_flag")int filter_flag, @PathParam("int_range_start_id")int range_start_ID, @PathParam("int_range_end_id")int range_end_ID) throws XmlRpcException{
        Object[] params = {credential,filter_flag, range_start_ID, range_end_ID};
