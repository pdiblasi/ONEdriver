...
public class OneSecGroupPool {
    ...
    /**
     * Creates a new instance of OneSecGroupPool
     */
    public OneSecGroupPool() {
       try{
    ...
    public String info(@PathParam("int_flter_flag")int filter_flag, @PathParam("int_range_start_id")int range_start_ID, @PathParam("int_range_end_id")int range_end_ID) throws XmlRpcException{
